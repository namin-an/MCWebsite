...
<div class="tot">
    <div>
        <img class="MainImg" src="posttest_sample_for_dev/19071131/64PIX_4GS_S001L1E01C7.jpg" alt="문제" id="image">
    </div>
    <div>
...
<form id="frm" action="action/Post_Test_MC2_F_Action.php" method="post">
