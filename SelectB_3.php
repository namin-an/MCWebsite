...
<script>
    ...
    function chk(txt){
        ...
        if(selAns == <?php echo $_SESSION['Answer']?>){
            ...
            location.href = 'Confirm_B_3.php?tm='+tm_toint+'&corr_cnt=1&selec='+selAns;
        }else{
            let time = $('#clock').val();
            let tm_totxt = time+"."+mil;
            let tm_toint = parseFloat(tm_totxt).toFixed(2);
            location.href = 'Confirm_B_3.php?tm='+tm_toint+'&incorr_cnt=1&selec='+selAns;
        }
